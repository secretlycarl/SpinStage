#!/usr/bin/env python3
"""Ensure packaged config/user-settings.json is present before tizen package."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Stage user-settings.json for Tizen package")
