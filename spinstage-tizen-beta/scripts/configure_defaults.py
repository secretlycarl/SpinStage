#!/usr/bin/env python3
"""Create config/user-settings.json for this Tizen build target."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Create Tizen config/user-settings.json")
    ...
    if args.stage:
        ...
        print("\nBuild with defaults: npm run package")
